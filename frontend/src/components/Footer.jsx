        ...
        <footer className="bg-white dark:bg-gray-900">
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
              <div>
                ...
                >
                  At the Graphics-Visualization-Computing-Lab at IIIT-Bangalore, we work on topics of visual analytics and spatial computing.
                </p>
            ...
            <div className="mt-12 border-t border-gray-100 pt-6 dark:border-gray-800">
              <div className="text-center sm:flex sm:justify-between sm:text-left">
                ...
                <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0 dark:text-gray-400">
                  &copy; 2025 Graphics-Visualization-Computing-Lab at IIIT-Bangalore
                </p>
              </div>
            </div>
            </div>
